...
global back sel
regexp 
puts $outfile "$frame: llength [lindex [measure contacts 3.5 $sel $back] 0] "
}

#Select molecule and trajectory
set mol [mol load psf 7k0016s2_tmao_wbiSHRT2.psf]

# set up the atom selections                                                                                      
set back [atomselect $mol "type O1P O2P"]
set sel [atomselect $mol "type OH2" ]
mol addfile 7k0016s2_tmao_wbiSHRT2.pdb

# calculate g(r)   
set outfile [open WATERPHOSPHOR_gofr.dat w]  

bigdcd mygr auto 7k00_100ns_TMOremvd.dcd
