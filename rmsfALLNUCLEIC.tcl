...
set outfile [open rmsfnucleic.dat w]  
set nf [molinfo top get numframes]  

puts $nf

# "orient" alignment loop
set frame0 [atomselect $molref "chain A and nucleic and noh"]
for {set i 0} { $i <= $nf } {incr i} {
    set selframe [atomselect top "chain A and nucleic and noh" frame $i]
...
# rmsf loop
set sel [atomselect top "nucleic and name C1' and chain A"]
set i 1
